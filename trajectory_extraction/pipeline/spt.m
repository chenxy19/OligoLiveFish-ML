...
addpath(fullfile(script_dir, 'matlab_deps'));
...
for i = 1:ntrials
    ...
    if ASK == 1
        ...
        numlines = 1;
        % defaultanswer = {'0.31','0.10833','0','35','0','3','0.005','0','7','0','2','1'};
        defaultanswer = {'0.04','0.18333','5','10','0','5','0.001','0','9','0','3','1'};
        options.Resize = 'on';
        ...
        sptpara.cell_num=str2double(user_var{12});
